...
public class UserRepository {
	...
	public List<HashMap<String, Object>> userTable() {
		...
		UsersBean user1 = new UsersBean(101, "Chandler Bing", "chandlerbing", "chandler@123", "chandler@gmail.com",
				"User");
		...
		UsersBean user2 = new UsersBean(102, "Monica Geller", "monicageller", "monica@123", "monica@gmail.com",
				"Admin");
		...
		UsersBean user5 = new UsersBean(105, "Phoebe Buffay", "phoebebuffay", "phoebe@123", "phoebe@gmail.com",
				"Manager");
